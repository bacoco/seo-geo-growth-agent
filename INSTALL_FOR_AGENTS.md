...
git clone --depth 1 --branch v1.2.7 https://github.com/bacoco/seo-geo-growth-agent.git "$INSTALL_TMP/seo-geo-growth-agent"
...
6. ARD / ai-catalog validation when the site exposes agentic resources
