...
Generated by `seo-geo-growth-agent` for `bacoco/seo-geo-growth-agent`.
...
- `/for-ai` returns HTTP 200 and has a canonical link to `https://github.com/bacoco/seo-geo-growth-agent`.
