...
def check_install_script() -> None:
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        for rel in (
            ...
            "examples/preprod-gated-audit/audit.json",
            "examples/preprod-gated-audit/index.html",
            "examples/preprod-gated-audit/LATEST-SEO-GEO-REPORT.md",
            "examples/preprod-gated-audit/report-validation.json",
